...
export const HOOKAH_CLASSIC_FLAVORS = [
  'Blueberry', 'Blueberry Mint', 'Mint', 'Pan Candy', 'Two Apple',
];

export const HOOKAH_SPECIALS = [
  { name: 'Mix Fresh Fruits Hookah', desc: 'Seasonal fruits, mint, lemon etc.', price: '399' },
  { name: '69 Special Hookah',       desc: 'Lemon ice tea & berry / two apples with cranberry / bad boy / Friday 13 / love 66 / 1001 night', price: null },
];
...
export const FOOD_NONVEG_SNACKS = [
...
export const GALLERY_ITEMS = [
  { title: 'Premium Lounge Area', category: 'lounge', is_large: true, cssClass: 'lounge-1' },
  { title: 'Hookah Setup', category: 'hookah', is_large: false, cssClass: 'hookah-1' },
  { title: 'Signature Cocktails', category: 'drinks', is_large: false, cssClass: 'drinks-1' },
  { title: 'VIP Section', category: 'lounge', is_large: false, cssClass: 'lounge-2' },
  { title: 'Live Events Night', category: 'events', is_large: true, cssClass: 'events-1' },
  { title: 'Cozy Corners', category: 'lounge', is_large: false, cssClass: 'lounge-3' },
  { title: 'Premium Hookah Flavors', category: 'hookah', is_large: false, cssClass: 'hookah-2' },
  { title: 'Craft Mocktails', category: 'drinks', is_large: false, cssClass: 'drinks-2' },
  { title: 'Birthday Celebrations', category: 'events', is_large: false, cssClass: 'events-2' },
];
